...
contextBridge.exposeInMainWorld('hourglass', {
  ...
  addStopwatch: (name, keybind) => ipcRenderer.invoke('add-stopwatch', { name, keybind }),
  updateStopwatch: (id, fields) => ipcRenderer.invoke('update-stopwatch', { id, ...fields }),
  deleteStopwatch: (id) => ipcRenderer.invoke('delete-stopwatch', { id }),
